...
type ChannelOtherSettings struct {
	...
	ResponsesWebSocketEnabled             *bool                 `json:"responses_websocket_enabled,omitempty"` // Responses 上游是否支持 WebSocket；未配置时 OpenAI/Codex 默认支持
...
func (s *ChannelOtherSettings) SupportsResponsesWebSocket(channelType int) bool {
	if s != nil && s.ResponsesWebSocketEnabled != nil {
		return *s.ResponsesWebSocketEnabled
	}
