...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.UserExpirationAuth(), middleware.Distribute())
	{
	...
	relayV1Router.Use(middleware.GroupConcurrencyLimit())
	...
	relayGeminiRouter.Use(middleware.GroupConcurrencyLimit())
