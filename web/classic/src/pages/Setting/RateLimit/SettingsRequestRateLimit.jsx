        ...
        >
          <Form.Section text={t('模型请求速率限制')}>
            ...
            <Row>
              ...
              <Col xs={24} sm={12} md={8} lg={8} xl={8}>
                <Form.InputNumber
                  label={t('用户+分组 HTTP+WS 最大并发（始终生效）')}
                  step={1}
                  min={0}
                  max={2147483647}
                  extraText={t(
                    '默认 3，0 代表不限制；HTTP 与 WS 共享额度，独立于周期速率限制',
                  )}
                  ...
                  extraText={
                    <div>
                      ...
                      <ul>
                        ...
                        <li>
                          {t(
                            '示例：{"default": [200, 100, 3], "vip": [0, 1000, 10]}。',
                          )}
                        </li>
                        <li>
                          {t(
                        ...
                        <li>
                          {t(
                            '[最大并发数]必须大于等于0且不超过2147483647，0代表不限制。',
                          )}
                        </li>
                        <li>{t('旧的二元数组配置会继承上方全局并发限制。')}</li>
