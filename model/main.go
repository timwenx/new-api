...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&Token{}, "Token"},
		{&User{}, "User"},
		{&UserDailyTokenUsage{}, "UserDailyTokenUsage"},
		{&UserWeeklyTokenUsage{}, "UserWeeklyTokenUsage"},
		{&UserModelWeeklyTokenUsage{}, "UserModelWeeklyTokenUsage"},
...
func migrateClickHouseLogDB() error {
	...
	if err := LOG_DB.Exec("ALTER TABLE logs ADD COLUMN IF NOT EXISTS token_multiplier Float64 DEFAULT 1 AFTER completion_tokens").Error; err != nil {
		return err
	}
...
CREATE TABLE IF NOT EXISTS logs (
	...
	token_multiplier Float64 DEFAULT 1,
